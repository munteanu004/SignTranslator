...
class Viewer(moderngl_window.WindowConfig):
    ...
    def gui_info(self):
        """GUI to control play the text and videos."""
        imgui.set_next_window_position(1018, 42)
        imgui.set_next_window_size(562, 117)
        ...
        expanded, _ = imgui.begin("Text annotation", None)
